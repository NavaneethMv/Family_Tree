...
class Personaldetailscontainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding:
          const EdgeInsets.only(top: 18.0, right: 28, left: 28, bottom: 28),
      child: Container(
            ...
            children: [
              Center(
                child: Text(
                  ...
                  style: headingStyle(color: primaryColor, fontSize: 22),
                ),
              ),
              sizedBox_h10,
...
Widget detailsHeadingandValue(String heading, String value) {
  return Column(
    ...
    children: [
      Text(
        heading,
        style: subHeadingStyle(fontSize: 18),
        textAlign: TextAlign.center,
      ),
      sizedBox_h5,
      Text(
        value,
        style: subHeadingStyle(color: blackcolour, fontSize: 20),
